...
const Rating = ({ auditProjects, count, handleCount }: ratingProps) => {
  ...
  useEffect(() => {
    if (project && tokenData && tokenPriceHistory) {
  ...
  }, [project, tokenData, tokenPriceHistory]);
  ...
  const handleSaveFirstModal = async () => {
    try {
      const data = {
        ...
        platform: platform,
        language: language,
        contract_addr: project.contract_addr,
        member: project.member,
        codebase: codebase,
        circle_text: textInCircle,
        circle_subtext: subTxtInCircle,
        bottom_link: bottomLink,
        contract_audits: project.contract_audits,
        platform_audits: project.platform_audits,
        bug_bounty: project.bug_bounty,
        insurance: project.insurance,
        distribution: project.distribution,
        distribution_list: project.distribution_list,
        security_text: project.security_text,
        security_list: project.security_list,
        audited_files_text: project.audited_files_text,
        audited_files_list: project.audited_files_list,
        metho: project.metho,
        methodology_tags: project.methodology_tags,
        token_title: project.token_title,
        token_name: project.token_name,
        token: project.token,
        market_api: project.market_api,
        team_title: project.team_text,
        team_note: project.team_note,
        disclaimer: project.disclaimer,
        disclaimer_text: project.disclaimer_text,
      };
  ...
  const handleSaveSecondModal = async () => {
    try {
      const data = {
        ...
        logo: project.logo,
        audited_by: project.audited_by,
        safety_score: project.safety_score,
        price: project.price,
        market: project.market,
        onboard_date: project.onboard_date,
        tags: project.tags,
        ...
        circle_text: project.circle_text,
        circle_subtext: project.circle_subtext,
        bottom_link: project.bottom_link,
        contract_audits: project.contract_audits,
        platform_audits: project.platform_audits,
        bug_bounty: project.bug_bounty,
        insurance: project.insurance,
  ...
  const handleDiscardDistributionModal = () => {
    setDistribution(project.distribution)
    setDistributionList(project.distribution)
    setShowDistributionModal(false);
  };
  ...
  const handleColor = (index: number, color: string) => {
    ...
    let temp = {
      color: color,
      number: securityList[index].number,
  ...
  const handleDistribution = (e: any, index: number, field: number) => {
    let tDist = [];
    for (let i = 0; i < index; i++) {
  ...
  const handleMember = (e: any, index: number, field: number) => {
    let tempList = [];
    for (let i = 0; i < index; i++) {
      tempList.push(memberList[i]);
    }
    ...
    if (field === 0) {
      ...
      member.twitter = e.target.value;
    } else if (field === 4) {
      member.linkedin = e.target.value;
    } else {
      member.mail = e.target.value;
    }
        ...
        <div className="mx-4 my-4 md:my-10 flex flex-col" ref={gridItemRef}>
          ...
          <div className="my-10 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
            <div className="shadow-xl rounded-xl col-span-2 p-8 font-Manrope font-light flex flex-col justify-center gap-4 md:gap-8">
              <div className="text-sz20 text-blue flex flex-col items-end justify-end">
                {/* <div
                    ...
                    <div className="justify-center items-center flex fixed inset-0 z-50 outline-none focus:outline-none">
                      <div className="relative my-6 w-5/6 md:w-2/3 lg:w-3/5 xl:w-1/3 rounded-xl shadow-xl font-Manrope">
                        ...
                        <div className="border-0 rounded-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                          ...
                          {/*body*/}
                          <div
                            className="text-sz20 text-left bg-lightgray relative p-8 rounded-b-xl flex flex-col space-y-3 overflow-y-auto"
                            style={{ height: "700px" }}
                          >
                            ...
                            <div className="flex flex-col space-y-2">
                              ...
                              <input
                                ...
                                id="website-admin"
                                value={bottomLink}
                                onChange={(e) => setBottomLink(e.target.value)}
                                className="shadow-inner w-full rounded-lg bg-lightgray border border-blue focus:ring-blue-500 focus:border-blue-500 block text-sz16 border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Safety Rating"
                              />
                            </div>
              ...
              <div className="p-4 bg-gray rounded-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-8">
                ...
                <div className="font-Manrope font-light flex flex-col gap-4 md:gap-8">
                  <div className="flex flex-col">
                    ...
                    <div className="flex flex-row items-center space-x-2">
                      <div className="text-blue text-sz24">
                        {project?.codebase}
                      </div>
            ...
            <div className="w-full col-span-1 shadow-xl rounded-xl font-Manrope font-light flex flex-col gap-4">
              <div className="px-8 pt-8 flex flex-col gap-4">
                {/* <div
                  className="text-sz20 text-blue flex flex-row items-center justify-end space-x-2"
                        ...
                        <div className="border-0 rounded-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                          ...
                          >
                            ...
                            <div
                              ...
                              className="cursor-pointer text-sz20 text-blue flex flex-row items-center space-x-2"
                            >
                ...
                <div className="grid grid-cols-2">
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <div className="text-sz24">
                      {project.audited_by.map(
                        (audit: string, index: number) => (
                          <span
                            className={
                              index % 3 === 0
                                ? "text-green"
                          ...
                          >
                            {index !== project.audited_by.length - 1
                              ? audit + ","
                              : audit}
                          </span>
                        )
                ...
                <div className="grid grid-cols-2">
                  <div className="flex flex-col space-y-2">
                    ...
                    <div className="text-sz24">
                      {project.audited_by.length > 1 ? "Disable" : "Available"}
                    </div>
                  </div>
                  <div className="flex flex-col space-y-2">
                          ...
                          {distributionList.map((item: any, index: number) => (
                            <div className="flex flex-row items-center space-x-4">
                              <div className="flex flex-col space-y-2">
                                ...
                                <select
                                  id="role"
                                  className="h-10 bg-transparent w-28 py-1 rounded-lg shadow-sm border border-blue flex flex-row items-center justify-center"
                                  value={item.color}
                                  onChange={(e) =>
                                    handleDistribution(e, index, 0)
                                  }
                                >
            ...
            <div className="p-8 font-Manrope font-light">
              <div className="w-full rounded-xl p-4 bg-gray flex flex-col md:flex-row items-start md:items-center gap-8">
                ...
                <div className="px-2 text-sz20 font-Manrope font-light flex flex-col gap-8">
                  {project.distribution_list.map((data: any, index: number) => (
                    <>
                      {index < 4 && (
                        <div className="flex flex-row space-x-4">
                          <div className="px-2 py-1 rounded-full shadow-inner flex flex-row items-center space-x-2">
                            <div
                              className={
                                data.color === "yellow"
                                  ? "w-4 h-4 rounded-md bg-yellow"
                                  : data.color === "purple"
                                  ? "w-4 h-4 rounded-md bg-purple"
                                  : data.color === "green"
                                  ? "w-4 h-4 rounded-md bg-green"
                                  : "w-4 h-4 rounded-md bg-blue"
                              }
                            ></div>
                            <div
                              className={
          ...
          <div className="my-10 bg-lightgray rounded-xl shadow-xl flex flex-col">
            <div className="bg-gray px-6 py-4 rounded-t-xl flex flex-row items-start">
              <div className="w-full pl-4 text-blue text-sz30 font-bold font-pilat text-center">
                                ...
                                (tag: string, tagId: number) => (
                                  <div className="flex flex-col space-y-2">
                                    ...
                                    <input
                                      ...
                                      value={tag}
                                      onChange={(e) =>
                                        handleTagOfSecurityList(e, index, tagId)
                                      }
                      ...
                      <div className="border-0 rounded-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="text-sz20 text-left bg-lightgray relative p-8 rounded-b-xl flex flex-col space-y-3">
                          ...
                          <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="flex flex-col space-y-2">
                              <div className="text-sz20 text-blue">SHA-256</div>
                              {auditFilesList.map(
                                (audit: any, index: number) => (
                                  <input
                                    type="text"
                    ...
                    <div className="relative my-6 w-5/6 md:w-2/3 lg:w-3/5 xl:w-1/3 rounded-xl shadow-xl font-Manrope">
                      ...
                      <div className="border-0 rounded-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="text-sz20 text-left bg-lightgray relative p-8 rounded-b-xl flex flex-col space-y-3">
                          ...
                          <div className="flex flex-col space-y-2">
                            <div className="text-sz20 text-blue">Edit Tags</div>
                            <div className="grid grid-cols-3 gap-4">
                              <div className="flex flex-col space-y-2">
          ...
          <div className="my-10 bg-lightgray rounded-xl shadow-xl flex flex-col">
            <div className="bg-gray px-6 py-4 rounded-t-xl flex flex-row items-start">
              ...
              {/* <div
                className="text-blue text-sz20 font-Manrope flex flex-row items-center space-x-2 cursor-pointer"
                    ...
                    <div className="relative my-6 w-5/6 md:w-2/3 lg:w-3/5 xl:w-1/3 rounded-xl shadow-xl font-Manrope">
                      ...
                      <div className="border-0 rounded-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="text-sz20 text-left bg-lightgray relative p-8 rounded-b-xl flex flex-col space-y-3">
                          ...
                          <div className="flex flex-col space-y-2">
                            <div className="text-sz20 text-blue">
                              Edit Token Markets API
                            </div>
                            <input
                              type="text"
                              id="website-admin"
                              value={marketAPI}
                              onChange={(e) => setMarketAPI(e.target.value)}
                              className="shadow-inner w-full rounded-lg bg-lightgray border border-blue focus:ring-blue-500 focus:border-blue-500 block text-sz16 border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                              placeholder="dywqbdhb2wvdhjbwhjgvwhjdqwjknjkwnbjkbn"
                            />
                          </div>
                    ...
                    <div className="relative my-6 w-5/6 md:w-2/3 lg:w-3/5 xl:w-1/3 rounded-xl shadow-xl font-Manrope">
                      ...
                      <div className="border-0 rounded-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        >
                          ...
                          <div className="flex flex-col space-y-2">
                            <div className="text-sz20 text-blue">Note</div>
                            <textarea
                              rows={4}
                              value={memberNote}
                            ...
                            {memberList.map((member: any, index: number) => (
                              <div className="w-full flex flex-col space-y-2">
                                ...
                                <input
                                  ...
                                  id="website-admin"
                                  value={member.name}
                                  onClick={(e) => handleMember(e, index, 0)}
                                  className="shadow-inner w-full rounded-lg bg-lightgray border border-blue focus:ring-blue-500 focus:border-blue-500 block text-sz16 border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                  placeholder="Name"
                                />
                                <input
                                  ...
                                  id="website-admin"
                                  value={member.role}
                                  onClick={(e) => handleMember(e, index, 1)}
                                  className="shadow-inner w-full rounded-lg bg-lightgray border border-blue focus:ring-blue-500 focus:border-blue-500 block text-sz16 border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div className="flex flex-col space-y-2">
                                  <div className="grid grid-cols-3 space-x-2">
                                    <select
                                      id="role"
                                      className="w-full h-10 bg-transparent w-28 py-1 rounded-lg shadow-sm border border-blue flex flex-row items-center justify-center"
                                    >
                                    ...
                                    <input
                                      ...
                                      onClick={(e) => handleMember(e, index, 2)}
                                  ...
                                  <div className="grid grid-cols-3 space-x-2">
                                    ...
                                    <input
                                      ...
                                      onClick={(e) => handleMember(e, index, 3)}
                                      className="col-span-2 shadow-inner w-full rounded-lg bg-lightgray border border-blue focus:ring-blue-500 focus:border-blue-500 block text-sz16 border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                      placeholder="0xd4ebc61981e5B9AB392b68f2638012E2346D534C"
                                    />
                                  </div>
                                  <div className="grid grid-cols-3 space-x-2">
                                    ...
                                    <input
                                      ...
                                      onClick={(e) => handleMember(e, index, 4)}
                                      className="col-span-2 shadow-inner w-full rounded-lg bg-lightgray border border-blue focus:ring-blue-500 focus:border-blue-500 block text-sz16 border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                  ...
                                  <div className="grid grid-cols-3 space-x-2">
                                    ...
                                    <input
                                      ...
                                      id="website-admin"
                                      value={member.mail}
                                      onClick={(e) => handleMember(e, index, 5)}
                                      className="col-span-2 shadow-inner w-full rounded-lg bg-lightgray border border-blue focus:ring-blue-500 focus:border-blue-500 block text-sz16 border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <div className="my-10 bg-lightgray rounded-xl shadow-xl flex flex-col">
            <div className="bg-gray px-6 py-4 rounded-t-xl flex flex-row items-start">
              <div className="w-full pl-4 text-red text-sz20 md:text-sz30 font-bold font-pilat text-center">
                {project.disclaimer}
              </div>
              {/* <div
                className="text-blue text-sz20 font-Manrope flex flex-row items-center space-x-2 cursor-pointer"
                    ...
                    <div className="relative my-6 w-5/6 md:w-2/3 lg:w-3/5 xl:w-1/3 rounded-xl shadow-xl font-Manrope">
                      ...
                      <div className="border-0 rounded-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="text-sz20 text-left bg-lightgray relative p-8 rounded-b-xl flex flex-col space-y-3">
                          ...
                          <div className="flex flex-col space-y-2">
                            <div className="text-sz20 text-blue">Text</div>
                            <textarea
                              rows={4}
