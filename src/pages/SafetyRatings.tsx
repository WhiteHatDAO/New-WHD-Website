...
const SafetyRatings = () => {
  return (
    <div className="flex flex-col">
      ...
      <div className="my-8 p-10 bg-lightgray rounded-xl shadow-inner-xl flex flex-col space-y-8">
        ...
        {[1, 2, 3].map((item) => (
          <div className="shadow-xl border border-blue rounded-xl px-8 py-4 flex flex-row items-center space-x-4">
