    ...
    <div className="flex my-20 gap-x-16">
      <div className="w-2/3 border shadow-xl p-middle rounded-xl bg-lightgray border-blue">
        ...
        <div>
          ...
          <div className="mb-5 font-semibold leading-6 font-Manrope text-sz20 text-grey">Securing web3 initiative by WhiteHatDAO, building with simple UX.</div>
          ...
          <div className="flex justify-between mb-5 leading-6 font-Manrope text-sz16 text-blue">
            ...
            <div className="flex">
              Share Post <img src={share} alt="share" className="h-6 ml-3" />
            </div>
          </div>
          <img src={line} alt="line" className="w-full mb-5" />
              ...
              <div className="p-4 rounded bg-gray">
                ...
                <div className="flex items-center justify-between leading-6 text-blue">
                  <div className="flex">
                    ...
                    <img src={message} alt="message" className="h-6 ml-5 mr-2" /> 2
                  </div>
                  Reply
                </div>
              </div>
